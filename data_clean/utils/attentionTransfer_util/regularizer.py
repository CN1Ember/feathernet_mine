...
from utils.attentionTransfer_util.util import get_conv_num, get_fc_name
...
def get_reg_criterions(args, logger):
    if args.base_model_name in ['mobilefacenet_p0.5']:
        in_channels_list = [64, 128, 128, 128]
        feature_size = [28, 14, 14, 7]
    elif args.base_model_name in ['LResNet34E_IR']:
