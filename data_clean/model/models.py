...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, embedding_size=256, use_se=True):
        self.inplanes = 64
        self.use_se = use_se
...
def resnet34(args, **kwargs):
    model = ResNet(IRBlock, [3, 4, 6, 3], embedding_size=args.emb_size, use_se=args.use_se, **kwargs)
    return model
...
if __name__ == "__main__":
    ...
    model = ResNet(IRBlock, [3, 4, 23, 3], embedding_size=256, use_se=False)
    print(model)
