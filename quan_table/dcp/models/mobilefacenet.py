...
class Mobilefacenet(nn.Module):
    ...
    def __init__(self, bottleneck_setting=Mobilefacenet_bottleneck_setting, embed_size=512):
        ...
        # old
        # self.linear = nn.Linear(512, embed_size, bias=False)
        # self.bn5 = nn.BatchNorm1d(embed_size)

        # new
        self.linear = nn.Linear(512, embed_size)
        self.bn5 = nn.BatchNorm1d(embed_size, affine=False)  # new
