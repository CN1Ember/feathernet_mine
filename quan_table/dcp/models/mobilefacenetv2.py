...
class Mobilefacenetv2(nn.Module):
    ...
    def __init__(self, embedding_size=512, blocks=[2,8,16,4], fc_type='gdc'):
...
if __name__ == "__main__":
    # model = Mobilefacenetv2(blocks=[2, 8, 16, 4], embedding_size=256, fc_type="gdc")  # FLOPs: 933M, Number of parameters is: 1995776
    # model = Mobilefacenetv2(blocks=[2, 8, 16, 4], embedding_size=512, fc_type="gnap")  # FLOPs: 933M
    ...
    for module in model.modules():
        if isinstance(module, nn.Conv2d):
            count = count + 1
    print("model conv_layers num={}".format(count))
