...
def save_weight_table(net, calibration_path):
    ...
    moving_mean_table = OrderedDict()
    moving_var_table = OrderedDict()
...
def parse_arguments(argv):
    ...
    parser.add_argument('--model_path', type=str, help='model_path',
                        default='/home/xiezheng/lidaiyuan/Face_integration/pretrain_model/checkpoint_2.pth')
    parser.add_argument('--calibration_path', type=str, help='calibration_path',
                        default='/home/xiezheng/lidaiyuan/Face_integration/pretrain_model/checkpoint_2_weight.table')
