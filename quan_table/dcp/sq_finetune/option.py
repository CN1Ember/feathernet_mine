...
class Option(object):
    def __init__(self, conf_path):
        ...
        self.warmup_n_epochs = self.conf['warmup_n_epochs']  # number of warm up epochs
        self.warmup_lr = self.conf['warmup_lr']  # warm up learning rate
        self.step = self.conf['step']  # multi-step for linear learning rate
        self.cos_lr = self.conf['cos_lr']
        ...
        self.embed_size = self.conf['embed_size']
