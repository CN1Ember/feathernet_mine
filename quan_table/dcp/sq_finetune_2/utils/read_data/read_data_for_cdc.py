...
# CASIA-SURF training dataset and our private dataset
depth_dir_train_file = os.getcwd() +'/data/cdc_nir_outdoor/nir_train_comp.txt'
label_dir_train_file = os.getcwd() + '/data/cdc_nir_outdoor/label_train_comp.txt'
...
# # CASIA-SURF Val data
depth_dir_val_file = os.getcwd() +'/data/cdc_nir_outdoor/nir_test_comp.txt'
label_dir_val_file = os.getcwd() +'/data/cdc_nir_outdoor/label_test_comp.txt' #val-label 100%

# # JIDIAN Val data
# depth_dir_val_file = os.getcwd() +'/data/nir_outdoor_0224/nir_indoor_neg_0322_test.txt'
# label_dir_val_file = os.getcwd() +'/data/nir_outdoor_0224/label_nir_indoor_neg_0322_test.txt' #val-label 100%
