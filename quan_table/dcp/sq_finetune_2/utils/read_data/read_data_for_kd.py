...
# CASIA-SURF training dataset and our private dataset
depth_dir_train_file = os.getcwd() +'/data/nir_adapt_0423/nir_train_add0605.txt'
label_dir_train_file = os.getcwd() + '/data/nir_adapt_0423/label_train_add0605.txt'
# depth_dir_train_file = os.getcwd() +'/data/nir_adapt_0423/ori_train_list.txt'
# label_dir_train_file = os.getcwd() + '/data/nir_adapt_0423/label_train_indoor.txt'

# for NIR train
depth_dir_val_file = os.getcwd() +'/data/nir_adapt_0423/nir_val_add0605.txt'
label_dir_val_file = os.getcwd() + '/data/nir_adapt_0423/label_val_add0605.txt'
