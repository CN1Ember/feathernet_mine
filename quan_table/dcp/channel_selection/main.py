...
block_num = {'vgg19': 16, 'preresnet56': 27, 'resnet18': 8, 'LResnetxE-IR34':16,
             "mobilefacenet_v1":15, 'resnet50': 16}
...
class Experiment(object):
    ...
    def _load_pretrained(self):
        ...
        if self.settings.pretrained is not None:
            ...
            self.logger.info('auxnet_model epoch={}'.format(epoch))
    ...
    ############################### insightface_dcp ##################################
    def face_channel_selection_for_one_segment(self, original_segment, pruned_segment, middle_layer, aux_fc,
                                               pivot_index, index):
        """
