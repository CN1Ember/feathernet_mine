...
class Option(object):
    def __init__(self, conf_path):
        ...
        # self.grad_clip = self.conf['grad_clip']
        ...
        self.fc_type = self.conf['fc_type']
        self.width_mult = float(self.conf['width_mult'])
    ...
    def set_save_path(self):
        ...
        if self.net_type in ["preresnet", "resnet"]:
            self.save_path = self.save_path + \
                             "log_aux_{}_d{:d}_{}_bs{:d}_n{:d}_e{:d}_lr{:.3f}_step{}_{}/"\
