...
def parse_arguments(argv):
    ...
    # parser.add_argument('--suffix', type=str, help='', default='mobilefacenetPytorch_112x112')
    parser.add_argument('--suffix', type=str, help='', default='prunedMobilefacenetPytorch_112x112')
    ...
    parser.add_argument('--megaface-feature-dir', type=str, help='', default='/home/dataset/xz_datasets/Megaface/pytorch_mobilefacenet/'
                        'pytorch_pruned0.5_mobilefacenet_v1/pytorch_pruned0.5_mobilefacenet_v1_lr0.01_checkpoint25_feature-result/'
                                                                             'fp_megaface_112x112_norm_features')

    parser.add_argument('--facescrub-feature-dir', type=str, help='', default='/home/dataset/xz_datasets/Megaface/pytorch_mobilefacenet/'
                        'pytorch_pruned0.5_mobilefacenet_v1/pytorch_pruned0.5_mobilefacenet_v1_lr0.01_checkpoint25_feature-result/'
                                                                              'fp_facescrub_112x112_norm_features')

    # parser.add_argument('--megaface-feature-dir-out', type=str, help='',
    #                     default='/home/dataset/xz_datasets/Megaface/pytorch_mobilefacenet/pytorch_mobilefacenet_v1_model/'
    #                             'fast_pytorch_mobilefacenet_epoch34_feature-result/fp_megaface_112x112_norm_features_cm')
    # parser.add_argument('--facescrub-feature-dir-out', type=str, help='',
    #                     default='/home/dataset/xz_datasets/Megaface/pytorch_mobilefacenet/pytorch_mobilefacenet_v1_model/'
    #                             'fast_pytorch_mobilefacenet_epoch34_feature-result/fp_facescrub_112x112_norm_features_cm')
