...
class GNAP_block(nn.Module):
    def __init__(self, input_channel, num_class):
        ...
        self.conv1 = nn.Conv2d(input_channel, num_class, kernel_size=(1,1), stride=1, padding=0, bias=False)
...
class ZQMobileFaceNet(nn.Module):
    def __init__(self, embedding_size, blocks=[4,8,16,4]):
...
if __name__ == "__main__":
    ...
    # model = ZQMobileFaceNet(256)                  # 21.25 M
    # model = ZQMobileFaceNet(512, blocks=[4, 8, 16, 8])      # 29.88 M
    # model = ZQMobileFaceNet(512, blocks=[8, 16, 32, 8])  # 29.88 M
