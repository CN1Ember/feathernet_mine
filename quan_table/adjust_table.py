...
def parse_arguments(argv):
    ...
    #
    parser.add_argument('--weight_path', type=str, help='weight_path',
                        default='/home/lidaiyuan/feathernet2020/model/pytorchmodel/_172_best_block_w.table')
    parser.add_argument('--activation_path', type=str, help='activation_path',
                        default='/home/lidaiyuan/feathernet2020/model/pytorchmodel/_98_rm_block_act.table')
    parser.add_argument('--calibration_path', type=str, help='calibration_path',
                        default='/home/lidaiyuan/feathernet2020/model/pytorchmodel/_172.table')
