...
from insightface_v2.ncnn_quantization import Conv2d_Ncnn_int8, replace_layer_by_unique_name
...
def main(args):
    ...
    megaface_out = '/home/dataset/xz_datasets/Megaface/iccv_ms1m_result/ncnn-int8/' \
                   'mf-p0.5-without-p-fc-ncnn-int8-rgb-liujing-17-87.18_result_nofliped_python/' \
...
def parse_arguments(argv):
    ...
    parser.add_argument('--use_flip', type=bool, help='use_flip', default=False)
    parser.add_argument('--table_path', type=str, help='table_path',
                        default='/home/dataset/xz_datasets/Megaface/iccv_ms1m_result/ncnn-int8/iccv_mf_p0.5_sq_17_activation.table')
