...
def main(args):
    ...
    # for resnet34
    # megaface_out = '/home/dataset/xz_datasets/Megaface/pytorch_resnet34_epoch48_feature-result/' \
    #                'fp_megaface_112x112_norm_features'
    # facescrub_out = '/home/dataset/xz_datasets/Megaface/pytorch_resnet34_epoch48_feature-result/' \
    #                 'fp_facescrub_112x112_norm_features'

    # for mobilefacenet
    megaface_out = '/home/dataset/xz_datasets/Megaface/pytorch_mobilefacenet_r2-8-16-4_model/pytorch_mobilefacenetv2_epoch27_feature-result/' \
                   'fp_megaface_112x112_norm_features'
    facescrub_out = '/home/dataset/xz_datasets/Megaface/pytorch_mobilefacenet_r2-8-16-4_model/pytorch_mobilefacenetv2_epoch27_feature-result/' \
                    'fp_facescrub_112x112_norm_features'
    ...
    # for mobilefacenet
    check_point_params = torch.load('/home/dataset/xz_datasets/Megaface/pytorch_mobilefacenet_r2-8-16-4_model/checkpoint_27.pth')
    ...
    torch.save(model_state,
               '/home/dataset/xz_datasets/Megaface/pytorch_mobilefacenet_r2-8-16-4_model/insightface_mobilefacenetv2_epoch27.pth')
    model = model.cuda()
    model.eval()
...
def parse_arguments(argv):
    ...
    parser.add_argument('--gpu', type=str, help='', default='2')
