...
def parse_arguments(argv):
    ...
    parser.add_argument('--megaface-feature-dir', type=str, help='',
                        default='/home/dataset/xz_datasets/Megaface/pytorch_mobilefacenet/pytorch_pruned0.25_mobilefacenet_v1_better/fp_megaface_112x112_norm_features')
    parser.add_argument('--facescrub-feature-dir', type=str, help='',
                        default='/home/dataset/xz_datasets/Megaface/pytorch_mobilefacenet/pytorch_pruned0.25_mobilefacenet_v1_better/fp_facescrub_112x112_norm_features')
