...
from insightface_v2.insightface_data.data_pipe \
    import get_train_loader, get_all_val_data, get_one_val_data, get_val_pair, get_soft_finetune_train_loader
...
# insightface mobilefacenet_v1 nir_soft_finetuning: nir_data_1224: follow_liujing
def parse_args():
    parser = argparse.ArgumentParser(description='Train face network')
    # general
    parser.add_argument('--nir_data_mode', default='nir_face_1224', help='train_data mode: emore, emore_debug, nir_face, nir_face_1224')
    parser.add_argument('--rgb_data_mode', default='iccv_emore',
                        help='train_data mode: emore, emore_debug, nir_face, nir_face_1224')
    # 241
    ...
    parser.add_argument('--outpath', type=str,
                        default='/home/liujing/NFS/ICCV_challenge/xz_log/iccv_emore_log_gdc/baseline/mobilefacenet/'
                                ...
                                'mf_p0.5_without_p_fc_nir_soft_finetune_1224_epoch26_nostep', help='output path')
    ...
    # mobilefacent_p0.5_iccv_new_without_p_fc: checkpoint_35
    parser.add_argument('--pretrained', type=str, default="/home/liujing/NFS/ICCV_challenge/xz_log/iccv_emore_log_gdc/baseline/mobilefacenet/2stage/dim128/finetune/log_aux_mobilefacenetv2_baseline_128_arcface_iccv_emore_bs512_e36_lr0.010_step[15, 25, 31]_p0.5_bs512_cosine_finetune_without_fc_20190809/check_point/checkpoint_035.pth",
                        help='pretrained model')
