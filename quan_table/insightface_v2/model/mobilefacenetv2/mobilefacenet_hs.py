...
class Mobilefacenet_hs(nn.Module):
    ...
    def __init__(self, bottleneck_setting=Mobilefacenet_bottleneck_setting, embedding_size=512):
        super(Mobilefacenet_hs, self).__init__()
        self.inplanes = 64
...
if __name__ == "__main__":
    ...
    param_num = model_analyse.params_count()
    print("model size={}".format(param_num * 4 / 1024 / 1024))
