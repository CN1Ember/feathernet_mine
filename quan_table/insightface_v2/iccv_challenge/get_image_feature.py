...
def parse_arguments(argv):
    ...
    # official
    # parser.add_argument('--model', type=str, help='', default='/home/xiezheng/program2019/insightface_DCP/'
    #                                                           'insightface_v2/iccv_challenge/r100-iccv/model,1')
    # parser.add_argument('--model', type=str, help='', default='/home/xiezheng/program2019/insightface_DCP/'
    #                                                           'insightface_v2/iccv_challenge/y2-iccv/model,1')

    # zq_mxnet
    # parser.add_argument('--model', type=str, help='', default='/home/xiezheng/programs2019/insightface_DCP/insightface_v2/'
    #                                                           'iccv_challenge/MobileFaceNet-res4-8-16-4-dim128/model,0')
    # parser.add_argument('--output', type=str, help='',
    #                     default='/home/xiezheng/programs2019/insightface_DCP/insightface_v2/'
    #                             'iccv_challenge/iccv_result/zq_MobileFaceNet-res4-8-16-4-dim128.bin')

    # zq_mxnet_train_softmax
    parser.add_argument('--model', type=str, help='', default='/home/xiezheng/programs2019/insightface_DCP/'
                                                              'insightface_v2/iccv_challenge/model/'
                                                              'mxnet_zq_mobilefacenet_r4-8-16-4_1955MFLOPs/'
                                                              'model-emore-softmax,173')
    parser.add_argument('--output', type=str, help='',
                        default='/home/xiezheng/programs2019/insightface_DCP/insightface_v2/'
                                'iccv_challenge/iccv_result/zq_MobileFaceNet-res4-8-16-4-dim512_train_softmax_arcface_173.bin')

    # mxnet_mobilefacenet_r3-8-16-5_gnap_521_995MFLOPs
    # parser.add_argument('--model', type=str, help='',
    #                     default='/home/xiezheng/programs2019/insightface_DCP/insightface_v2/iccv_challenge/model/'
    #                             'mxnet_mobilefacenet_r3-8-16-5_gnap_512_995MFLOPs/model-emore-test,64')
    # parser.add_argument('--output', type=str, help='',
    #                     default='/home/xiezheng/programs2019/insightface_DCP/insightface_v2/'
    #                             'iccv_challenge/iccv_result/mxnet_mobilefacenet_r3-8-16-5_gnap_512_995MFLOPs_64.bin')

    # parser.add_argument('--model', type=str, help='',
    #                     default='/home/xiezheng/programs2019/insightface_DCP/insightface_v2/'
    #                             'iccv_challenge/MobileFaceNet-res4-8-16-4-dim512/model,0')
    # parser.add_argument('--output', type=str, help='',
    #                     default='/home/xiezheng/programs2019/insightface_DCP/insightface_v2/'
    #                             'iccv_challenge/iccv_result/zq_MobileFaceNet-res4-8-16-4-dim512.bin')
