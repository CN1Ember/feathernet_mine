...
from insightface_v2.model.mobilefacenet_pruned import pruned_Mobilefacenet, pruned_Bottleneck_mobilefacenet
from insightface_v2.model.mobilefacenetv2_width_wm import Mobilefacenetv2_width_wm, Bottleneck_mobilefacenetv2

from insightface_v2.ncnn_quantization import Conv2d_Ncnn_int8
...
def int8_train_replace(model, logger):
    ...
    logger.info("after replace: {}".format(model))
...
def train_net(args):
    ...
    if args.pretrained != '' :
        ...
        logger.info("epoch={}, val_acc={}".format(pretrained_state['epoch'], pretrained_state['val_acc']))
    ...
    int8_train_replace(model, logger)
