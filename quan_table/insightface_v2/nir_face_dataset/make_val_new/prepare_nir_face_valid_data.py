...
def load_val(lines, data_path, store_path, image_size=[112, 112]):
    ...
    for i in range(len(lines)):
        ...
        img1_path = replace_str(img1_path)
        img2_path = replace_str(img2_path)
        # print("{} - {} - {}".format(img1_path, img2_path, label))
        ...
        if label == "1":
            ...
            assert False
        marks.append(mark)
        print("i={}, {}, {}, {}, {}".format(i, img1_path, img2_path, label, mark))
        # if i == 10:
        #     break
    print(data.shape)
...
if __name__ == '__main__':
    ...
    # nir_face_400_test_TPR_dataset_make

    data_path = "/home/datasets/Face/FaceRecognition/nir_face_dataset_1224/nir_jidian_test_400_190727_align"
    valid_data_txt = '/home/datasets/Face/FaceRecognition/nir_face_dataset_1224/' \
                     'sample_valid_list_for_jidian_test_400_190727_align_160000_pairs.txt'
    store_dir = "/home/datasets/Face/FaceRecognition/nir_face_dataset_1224/nir_face_test_400_verfication_data_160000_pairs"
