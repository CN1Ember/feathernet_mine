...
log_filename = 'cfp_fp_accuracy.csv'
...
# plt.show()
# plt.savefig(os.path.join(dir_path, 'cfp_accuracy.pdf'))
plt.savefig(os.path.join(dir_path, 'cfp_accuracy.jpg'))