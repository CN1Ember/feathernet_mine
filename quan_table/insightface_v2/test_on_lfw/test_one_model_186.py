...
if __name__ == "__main__":
    ...
    outpath = '/home/dataset/xz_datasets/Megaface/ms1mv2_pytorch_r34/test_pami_face_flip_result'

    # 186
    # ms1mv2_test
    emore_folder = '/home/dataset/Face/FaceRecognition/faces_ms1m-refine-v2_112x112/faces_emore'
    ...
    # model_path = '/home/xiezheng/programs2019/insightface_DCP/insightface_v2/log/' \
    #              'insightface_r34/insightface_r34_with_arcface_v2_epoch48.pth'

    # model_path = '/home/dataset/xz_datasets/Megaface/ms1mv2_pytorch_r34/' \
