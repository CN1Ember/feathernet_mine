...
def train_net(args):
                ...
                if args.network == 'mobilefacenet_v1':
                    ...
                    optimizer = optim.SGD([{'params': model.conv_6_sep.parameters(), 'weight_decay': 4e-5},
                     ...
                     if args.last_type == 'last1':
                         ...
                         # [last_3 + arcface] update
                         optimizer = optim.SGD([{'params': model.conv3.parameters()},
                                                {'params': model.bn3.parameters()},
                                                {'params': model.prelu3.parameters()},
    ...
    if args.focal_loss:
        ...
        criterion = CrossEntropyLabelSmooth(num_classes, 0.1)
        logger.info("CrossEntropyLabelSmooth !!!")
