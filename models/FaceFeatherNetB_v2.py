...
class FaceFeatherNet_v2(nn.Module):
    def __init__(self, n_class=2, img_channel=1,input_size=112, se=False, avgdown=False, width_mult=1.0):
        ...
        interverted_residual_setting = [
            ...
            # # t, c, n, s remember to uncomment this for old versions 20191014-09:54
            # [1, 16, 1, 1],
            # [6, 32, 2, 2],  # 56x56
            # [6, 48, 6, 2],  # 14x14
            # [6, 64, 3, 2],  # 7x7
...
def FaceFeatherNetA_v2(se=False, width_mult=1.0):
    model = FaceFeatherNet_v2(se = se, width_mult=width_mult)
    return model

def FaceFeatherNetB_v2(se=True, img_channel=1, width_mult=1.0):
