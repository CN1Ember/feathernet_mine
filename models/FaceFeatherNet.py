...
def FaceFeatherNetA(se=False, width_mult=1.0):
    model = FaceFeatherNet(se = se, width_mult=width_mult)
    return model

def FaceFeatherNetB(se=True, width_mult=1.0):
    model = FaceFeatherNet(se=se, avgdown=True, width_mult=width_mult)
    return model
