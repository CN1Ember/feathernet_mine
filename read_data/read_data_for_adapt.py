...
# source valid set
source_val_img_file = os.getcwd() +'/data/nir_adapt_0423/nir_val_company.txt'
source_val_label_file = os.getcwd() +'/data/nir_adapt_0423/label_val_company.txt' #val-label 100%
