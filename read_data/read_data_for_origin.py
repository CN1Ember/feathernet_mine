...
# CASIA-SURF training dataset and our private dataset
depth_dir_train_file = os.getcwd() +'/data/nir_adapt_0402/nir_train_02.txt'
label_dir_train_file = os.getcwd() + '/data/nir_adapt_0402/label_train_02.txt'
...
# # CASIA-SURF Val data
depth_dir_val_file = os.getcwd() +'/data/nir_adapt_0402/nir_val_02.txt'
label_dir_val_file = os.getcwd() +'/data/nir_adapt_0402/label_val_02.txt' #val-label 100%
